...
@InputType()
class AuditLogCreateNestedManyWithoutDocumentsInput {
...
export { AuditLogCreateNestedManyWithoutDocumentsInput as AuditLogCreateNestedManyWithoutDocumentsInput };
